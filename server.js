...
【重要】回答をより分かりやすくするために、以下のリストに使える図解があれば「積極的に」使用してください。複数枚使っても構いません。
図解を使う場合は、回答の最後に [IMG:ファイル名] の形式で出力してください。複数使う場合は [IMG:forwards.jpg][IMG:backs.jpg] のように並べて出力します。
